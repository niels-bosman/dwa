...
wsConnection.onmessage = function (eventInfo) {
  ...
  switch (message.messageType) {
    case 'CHOICE ACCEPTED':
      notificationBox.innerHTML = 'Your choice has been registered by the server.';
      break;
    case 'CHOICE NOT ACCEPTED':
      alert('Mistake:\n' + message.reason);
      break;
    case 'OPPONENT CHOICE':
      notificationBox.innerHTML = message.opponentName + ' has submitted his/her choice...';
      break;
    case 'WIN':
      notificationBox.innerHTML = 'YOU WIN!!!!';
      scoreDisplay.innerHTML    = userNameField.value + ': ' + message.ownScore +
        '&nbsp;&nbsp;&nbsp;--&nbsp;&nbsp;&nbsp;' +
        message.opponentName + ': ' + message.opponentScore;
      break;
    case 'LOSE':
      ...
      break;
    case 'TIE':
      notificationBox.innerHTML = 'A Tie. Nobody wins or loses. Play a new round.';
      break;
    case 'OPPONENT LEFT':
      notificationBox.innerHTML = 'Game Over: ' + message.opponentName + ' disconnected.';
      break;
    default:
